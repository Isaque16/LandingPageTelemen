async function init() {
  ...
  function setupClickListener(id, type) {
    ...
    radioButton.addEventListener("click", () => placePicker.type = type);
  }
  ...
  strictBoundsInputElement.addEventListener("change", () => placePicker.strictBounds = strictBoundsInputElement.checked);
}
